...
1. Serve this PR branch from the RTX desktop machine itself so Playwright hits the current profiling instrumentation from branch head `e241e2d` instead of the `main` GitHub Pages site:
