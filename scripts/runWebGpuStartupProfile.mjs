...
import {
  ...
  writeStartupProfileUploadManifest,
} from './writeWebGpuStartupProfileUploadManifest.mjs';
...
async function main() {
  ...
  try {
    ...
    if (reportResult) {
      ...
      console.info(`[webgpu-startup-profile] upload manifest: ${reportResult.artifactOutputDir}/startup-profile-upload-manifest.json`);
    }
  } catch (error) {
